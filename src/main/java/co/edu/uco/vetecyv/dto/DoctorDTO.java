...
public class DoctorDTO extends DTO {
    ...
    public DoctorDTO(final UUID id, final String identityDocument, final String name, final String firstLastName, final String secondLastName,
    ...
    public static DoctorDTO createDefault() {
