...
public final class AdministratorDomain extends Domain {
    ...
    private boolean phoneConfirmationDefaultValue;
    private boolean accountStateDefaultValue;
    ...
    AdministratorDomain() {
        ...
        setPhoneConfirmationDefaultValue(true);
        setAccountStateDefaultValue(true);
    }
    ...
    public AdministratorDomain(final UUID id, final String identityDocument, final String name, final String firstLastName,
            final String secondLastName, final String email, final String phoneNumber, final String password,
            final boolean emailConfirmation, final boolean phoneConfirmation, final boolean accountState) {
        super(id);
        ...
        setPhoneConfirmationDefaultValue(false);
        setAccountStateDefaultValue(false);
    }

    protected static AdministratorDomain getDefaultValue() {
        return new AdministratorDomain();
    }

    static AdministratorDomain getDefaultValue(final AdministratorDomain admin) {
        return ObjectHelper.getDefault(admin, getDefaultValue());
    }
    ...
    private void setEmailConfirmationDefaultValue(final boolean emailConfirmationDefaultValue) {
        this.emailConfirmationDefaultValue = emailConfirmationDefaultValue;
    }

    public boolean isPhoneConfirmationDefaultValue() {
        return phoneConfirmationDefaultValue;
    }

    private void setPhoneConfirmationDefaultValue(final boolean phoneConfirmationDefaultValue) {
        this.phoneConfirmationDefaultValue = phoneConfirmationDefaultValue;
    }

    public boolean isAccountStateDefaultValue() {
        return accountStateDefaultValue;
    }

    private void setAccountStateDefaultValue(final boolean accountStateDefaultValue) {
        this.accountStateDefaultValue = accountStateDefaultValue;
    }
}