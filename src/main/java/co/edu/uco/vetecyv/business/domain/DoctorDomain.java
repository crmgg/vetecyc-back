...
public final class DoctorDomain extends Domain {
    ...
    public DoctorDomain(final UUID id) {
        super(id);
        setIdentityDocument(TextHelper.getDefault());
        setName(TextHelper.getDefault());
        setFirstLastName(TextHelper.getDefault());
    ...
    public DoctorDomain(final UUID id, final String identityDocument, final String name, final String firstLastName,
    ...
    protected static DoctorDomain getDefaultValue() {
        return new DoctorDomain();
    }

    static DoctorDomain getDefaultValue(final DoctorDomain doctor) {
