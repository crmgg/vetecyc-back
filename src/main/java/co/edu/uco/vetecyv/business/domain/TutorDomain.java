...
public final class TutorDomain extends Domain {
    ...
    public TutorDomain(final UUID id) {
    ...
    public TutorDomain(final UUID id, final String identityDocument, final String name, final String firstLastName,
    ...
    protected static TutorDomain getDefaultValue() {
        return new TutorDomain();
    }

    static TutorDomain getDefaultValue(final TutorDomain tutor) {
